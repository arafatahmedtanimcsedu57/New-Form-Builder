...
import FormComponentEdit from "./_components/FormComponentEdit";
  ...
  return (
    <div className="flex flex-col h-full">
      <DndProvider backend={HTML5Backend}>
        <div className="flex flex-row gap-4 w-full h-full justify-between">
          {/* Left Side */}
          <FormEntities
          ...
          {/* Right Side */}
          {selectedEntity ? (
            <FormComponentEdit selectedEntity={selectedEntity} />
          ) : (
            <div></div>
          )}
        </div>
