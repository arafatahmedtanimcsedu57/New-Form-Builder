...
const Hero = () => {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 text-center lg:pt-32">
      <p className="mx-auto -mt-4 max-w-2xl sm:text-2xl tracking-tight text-slate-400 sm:mt-6 mb-4">
        Welcome to{" "}
      ...
      <h1 className="mx-auto max-w-5xl text-2xl font-extrabold text-slate-800 sm:text-5xl">
        <span className="inline-block">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-blue-300/70 motion-preset-fade-lg"
            ...
            <span className="relative">Powerful Forms</span>
          </span>
        </span>{" "}
